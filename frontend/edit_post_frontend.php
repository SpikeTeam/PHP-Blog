        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-heading">
                    ...
                    <?php endif; ?>
                    <form method ="POST">
                        <h1><input type="text" name="title" id="title" style="margin: 0;padding: 0;background-color: transparent;" value ="<?= htmlspecialchars($data->getTitle())?>" required></h1>
                        <h2 class="subheading"><input type="text" name="about" id="about" style="margin: 0;padding: 0;background-color: transparent;" value ="<?= htmlspecialchars($data->getAbout())?>" required></h2>
                </div>
            </div>
        </div>
    </div>
...
<article class = text-center>
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <textarea name="content" id="content" style="margin: 0;padding: 0;background-color: transparent;width:40em" required><?= htmlspecialchars($data->getContent())?></textarea>
            </div>
        </div>
    </div>
