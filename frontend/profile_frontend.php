    ...
    <div class="row profile">
        <div class="col-md-3">
            <div class="profile-sidebar">
                ...
                <div class="profile-userbuttons">
                    ...
                    <a href="./create_post.php"><input type="button" class="btn btn-danger btn-sm" value="Create post"/></a>
                </div>
                <!-- END SIDEBAR BUTTONS -->
                <!-- SIDEBAR MENU -->
                    ...
                    <ul class="nav">
                        ...
                        <li>
                            <a href="#">
                                ...
                                <?= htmlspecialchars($_SESSION['countPosts']['countPosts']) ?> </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="glyphicon glyphicon-paste">Count comments: </i>
                                <?= htmlspecialchars($_SESSION['countComments']['countComments']) ?></a>
                        </li>
                    </ul>
                </div>
                <!-- END MENU -->
        ...
        <div class="col-md-9">
            <div class="profile-content">
                <?= htmlspecialchars($_SESSION['personalInfo']) ?>
            </div>
        </div>
    </div>
</div>
