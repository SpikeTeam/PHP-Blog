...
<head>
    ...
    <title><?= htmlentities($data->getTitle()) ?></title>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-heading">
                    <h1><?= htmlentities($data->getTitle()) ?></h1>
                    <h2 class="subheading"><?= htmlentities($data->getAbout()) ?></h2>
                    <span class="meta">Posted by <a
                                href="#"><?= htmlentities($data->getAuthor()) ?></a> on <?= htmlentities($data->getDatePosted()); ?></span>
                </div>
            </div>
        </div>
    </div>
...
<?php if (isset($_SESSION['id'])): ?>
    <?php if ($_SESSION['id'] == $data->getUserId()): ?>
        ...
        <div class="text-center">
            <a href="edit_post.php?postId=<?= $data->getId(); ?>" class="btn btn-md btn-warning">Edit</a>
            <a href="delete_post.php?postId=<?= $data->getId(); ?>" class="btn btn-md btn-danger">Delete</a>
        </div>
    <?php endif ?>
<?php endif ?>
<hr>
...
<script src="frontned/vendor/bootstrap/js/bootstrap.min.js"></script>
