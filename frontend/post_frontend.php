        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-heading">
                    <h1><?= htmlspecialchars($data->getTitle()) ?></h1>
                    <h2 class="subheading"><?= htmlspecialchars($data->getAbout()) ?></h2>
                    <span class="meta">Posted by <a
                                href="#"><?= htmlspecialchars($data->getAuthor()) ?></a> on <?= htmlspecialchars($data->getDatePosted()); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <?= htmlspecialchars($data->getContent()); ?>
            </div>
        </div>
    </div>
</article>
