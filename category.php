...
if(isset($_GET['delcategory'])){
    ...
    $stmt = $db->prepare('DELETE FROM blog_cats WHERE category_ID = :category_ID') ;
    $stmt->execute(array(':category_ID' => $_GET['delcategory']));
...
<div id="wrapper">
    ...
    <table>
        ...
        try {
            ...
            $stmt = $db->query('SELECT category_ID, catTitle, catSlug FROM blog_cats ORDER BY catTitle DESC');
            while($row = $stmt->fetch()){
                ...
                <td>
                    ...
                    <a href="javascript:delcat('<?php echo $row['category_ID'];?>','<?php echo $row['catSlug'];?>')">Delete</a>
                </td>
